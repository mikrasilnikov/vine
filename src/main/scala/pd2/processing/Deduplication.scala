...
object Deduplication {
  ...
  : ZIO[Config with Pd2Database with Logging, Throwable, DeduplicationResult] =
  {
  ...
  def markAsCompleted(deduplicationResult: DeduplicationResult): ZIO[Pd2Database, Throwable, Unit] =
  {
